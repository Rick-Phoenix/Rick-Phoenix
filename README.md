...
My most important project so far is [protify](https://github.com/Rick-Phoenix/protify), which aims to transform the experience of working with protobuf in the Rust ecosystem. It generates entire protobuf packages from Rust code, and handles validation logic with a powerful and highly customizable validation framework.
...
- [proto-types](https://github.com/Rick-Phoenix/proto-types), a crate with a comprehensive set of implementations for well known proto types
...
If you find my work valuable, please consider [sponsoring me on GitHub](https://github.com/sponsors/Rick-Phoenix) to support continued development.

I am currently open to remote engineering roles (EU/US timezones) focused on Rust, backend systems, and developer tooling. If you are solving interesting problems in this space, [I'd love to chat](mailto:rick-phoenix@outlook.com)
